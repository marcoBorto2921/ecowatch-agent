...
<head>
  ...
  <style>
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    .stats-bar {{ background: #2d6a4f; padding: 20px 48px; display: flex; justify-content: space-between; }}    .content {{ padding: 48px; }}
...
<body>
  <div class="wrapper">
    ...
    <div class="stats-bar">
      <div class="stat" style="text-align:center; flex:1;"><span>{len(ranked_articles)}</span>Articles analyzed</div>
      <div class="stat" style="text-align:center; flex:1;"><span>3</span>Thematic sections</div>
      <div class="stat" style="text-align:center; flex:1;"><span>1</span>Time per week</div>
    </div>
